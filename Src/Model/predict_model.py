...
class TransE:
    def __init__(self, kg: KnowledgeGraph, score_func):
        ...
        '''embeddings'''
        self.entity_embedding = tf.constant(np.load('../../Data/Embeddings/ent_embeddings.npy'))
        self.relation_embedding = tf.constant(np.load('../../Data/Embeddings/rel_embeddings.npy'))
